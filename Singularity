...
export R_LIBS="/usr/local/share/R-4.3"
...
bash -c 'add-apt-repository universe -y'
...
bash -c 'curl -fsSL -O https://afni.nimh.nih.gov/pub/dist/tgz/linux_ubuntu_24_64.tgz && tar -xf linux_ubuntu_24_64.tgz && mv linux_ubuntu_24_64 /usr/local/abin && rm -f linux_ubuntu_24_64.tgz'

bash -c 'curl -fsSL -O https://afni.nimh.nih.gov/pub/dist/tgz/package_libs/linux_ubuntu_24_R-4.3_libs.tgz && tar -xf linux_ubuntu_24_R-4.3_libs.tgz && mv linux_ubuntu_24_R-4.3_libs /usr/local/share/R-4.3 && rm -f linux_ubuntu_24_R-4.3_libs.tgz'

bash -c 'export PATH=/usr/local/abin:$PATH && export R_LIBS=/usr/local/share/R-4.3 && rPkgsInstall -pkgs ALL'
...
printf '{ \
  ...
  "instructions": [ \
    ...
    { \
      "name": "run", \
      "kwds": { \
        "command": "bash -c '"'"'add-apt-repository universe -y'"'"'" \
      } \
    }, \
    { \
      "name": "install", \
    ...
    { \
      "name": "run", \
      "kwds": { \
        "command": "bash -c '"'"'curl -fsSL -O https://afni.nimh.nih.gov/pub/dist/tgz/linux_ubuntu_24_64.tgz && tar -xf linux_ubuntu_24_64.tgz && mv linux_ubuntu_24_64 /usr/local/abin && rm -f linux_ubuntu_24_64.tgz'"'"'" \
      } \
    }, \
    { \
      "name": "run", \
      "kwds": { \
        "command": "bash -c '"'"'curl -fsSL -O https://afni.nimh.nih.gov/pub/dist/tgz/package_libs/linux_ubuntu_24_R-4.3_libs.tgz && tar -xf linux_ubuntu_24_R-4.3_libs.tgz && mv linux_ubuntu_24_R-4.3_libs /usr/local/share/R-4.3 && rm -f linux_ubuntu_24_R-4.3_libs.tgz'"'"'" \
      } \
    }, \
    { \
      "name": "env", \
    ...
    { \
      "name": "run", \
      "kwds": { \
        "command": "bash -c '"'"'export PATH=/usr/local/abin:$PATH && export R_LIBS=/usr/local/share/R-4.3 && rPkgsInstall -pkgs ALL'"'"'" \
      } \
    }, \
    { \
      "name": "env", \
